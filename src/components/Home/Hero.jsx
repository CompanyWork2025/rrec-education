  ...
  return (
    <div className="relative w-full lg:h-[650px] flex flex-col items-center justify-center bg-gray-900 text-white">
      ...
      >
        ...
        <h1
          className={`text-2xl md:text-4xl px-8 lg:text-6xl md:mt-8 lg:mt-0 max-w-5xl text-center font-bold drop-shadow-lg transition-all duration-500 ease-in-out ${
            isFading
